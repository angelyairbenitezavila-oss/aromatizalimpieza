# -*- coding: utf-8 -*-
"""proyectofina3par.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1frHSXNOGqrcab_n01pUFDyRC4QGqmnwi
"""

# instalamos las librerias que faltan para graficar y conectar a mongo
!pip install pymongo dnspython streamlit plotly pandas -q
...
#         if not df_emp.empty:
#             # grafica de dona para ver la cantidad por puesto
...
# 
#             # lista numerada con el conteo de personas
...
#             st.write("---")
# 
#             # grafica de barras sumando los salarios por cada puesto diferente
...
# 
#             # suma total automatica de la nomina
...
# 
#         # primer paso: pantalla vacia con un solo boton
...
#                 st.rerun()
# 
#         # segundo paso: escoger a quien se le compra
...
#                     st.rerun()
# 
#             # filtra para mostrar solo los productos que surte este proveedor
...
#                     st.rerun()
# 
#         # cuarto paso: diseño limpio para la captura con datos de contacto arriba
...
#             st.markdown("""
#                 <br><br>
#                 <p style="text-align: center; font-size: 12px; color: #aaa;">Generado automáticamente por el Sistema Aromatiza en Google Colab.</p>
#             </div>
#             """, unsafe_allow_html=True)
# 
#             st.write("")
...
# abrimos el servidor de streamlit por detras
import subprocess
print("prendiendo streamlit...")
subprocess.Popen(["nohup", "streamlit", "run", "app.py"])

# sacamos la ip publica de colab
print("\n--- copia este numero de ip ---")
!curl ipv4.icanhazip.com

# generamos el enlace publico aceptando la instalacion automaticamente
print("\nabre el siguiente enlace y pega la ip de arriba:")
!npx localtunnel --port 8501 --yes